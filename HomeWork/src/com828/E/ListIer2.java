...
public class ListIer2 {
	
	public static void main(String[] args) {
		ListIer2 lis=new ListIer2();
...
//		System.out.println("hhh"+( (LinkedList<Dog>) coll).element().getName());
	...
	public void show(HashSet<Dog> coll)
	{
		System.out.println("总共有"+coll.size()+"条小狗");
		System.out.println("序号        名字        品种  ");
		Iterator<Dog> list=coll.iterator();
		while(list.hasNext())
		{
			Dog dog=list.next();
			System.out.println(dog.getId()+"  "+dog.getName()+"  "+dog.getType());
